...
$this->title = 'Update Car : ' . $model->number . " " . $model->prov;
$this->params['breadcrumbs'][] = ['label' => 'Cars', 'url' => ['index']];
$this->params['breadcrumbs'][] = ['label' => $model->number . " " . $model->prov, 'url' => ['view', 'id' => $model->id]];
...
<div class="car-update">
    ...
    <div class="form-group">
        ...
        <button class="btn btn-danger" onclick="$('#main-modal').modal('hide')">Close</button>
    </div>
<?php ActiveForm::end(); ?>
</div>
